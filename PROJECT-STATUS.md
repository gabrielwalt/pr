...
| Search | `/search` | 🔲 | 🔲 | New 2026-07-09. Standalone page = a single `project-table search` block (same rows as Home's index). Nav "Search" now links here (`/search`, was `/#search`). Awaiting user GATE 1/2. |
