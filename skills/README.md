...
| [vertical-spacing-system](vertical-spacing-system/SKILL.md) | Foundation spacing + universal block-spacing variants; blocks touching with no gap; sections too far apart; page rhythm wrong; a stray colored band/gap between full-bleed sections (section-padding when the surface is on the inner div) |
...
| [component-library](component-library/SKILL.md) | Foundation is set and you want a living design-system reference + GATE-2 diff target + author-insertable palette, all in ONE library; after validating a new block/variant/section-style; wiring up the DA Library panel or UE component definition |
